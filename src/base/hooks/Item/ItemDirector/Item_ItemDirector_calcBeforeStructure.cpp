...
namespace base
{
    ...
    {
        auto drive_during_sync = features::mode::drive_during_sync_before(_this->m_mode_manager);
        ...
        features::mode::drive_during_sync_after(_this->m_mode_manager, drive_during_sync);
    }
}